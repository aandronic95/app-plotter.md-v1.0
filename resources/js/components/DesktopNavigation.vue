        ...
        <div class="mx-auto max-w-7xl px-4 md:px-6">
            <nav v-if="!isLoading && menuItems.length > 0" class="flex h-12 items-center justify-center gap-1">
                <Link
                    ...
                    class="group relative flex items-center gap-1.5 rounded-md px-4 py-2 text-sm font-semibold uppercase tracking-wide text-gray-900 dark:text-gray-200 transition-all duration-200 hover:bg-white/10 dark:hover:bg-white/10 hover:text-gray-900 dark:hover:text-gray-200"
                >
